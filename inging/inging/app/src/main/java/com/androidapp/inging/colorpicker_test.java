...
@SuppressLint("NewApi")
public class colorpicker_test extends AlertDialog {
	static int old=0;
	...
	public interface OnColorSelectedListener {
		 ...
		 * possible if {@link colorpicker_test#setNoColorButton(int) setNoColorButton()}
		 * has been called on the dialog before showing it
		 */
		public void colorSelected(Integer color);
	}

	public colorpicker_test(Context context, int initialColor, final OnColorSelectedListener listener) {
		super(context);
		...
		if(old!=0){
			initialColor = old;
			//BORDER_COLOR = old;
			this.selectedColor = old;
			//Toast.makeText(context, "if", 1).show();
		}
	...
	private OnClickListener clickListener = new DialogInterface.OnClickListener() {
		public void onClick(DialogInterface dialog, int which) {
			...
			case BUTTON_POSITIVE:
				...
				old = selectedColor;
				if(com.androidapp.inging.MainActivity.Status == 0){} //Launcher.t.setText("��");
				else if(com.androidapp.inging.MainActivity.Status == 1){} //Launcher.t.setText("����");
				else if(com.androidapp.inging.MainActivity.Status == 2){
					if(com.androidapp.inging.MainActivity.PenStyle == 0){
						//Launcher.t.setText("�簢��_�׵θ�");
					}
					else {}//Launcher.t.setText("�簢��_ä���");
				}
				else if(com.androidapp.inging.MainActivity.Status == 3) {
					if(com.androidapp.inging.MainActivity.PenStyle == 0){
						//Launcher.t.setText("��_�׵θ�");
					}
					else {}//Launcher.t.setText("��_ä���");
				}
